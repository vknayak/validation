...
const data = [
    ...
    },
    {
      ...
      "name": "state",
      "type": "select",
      "validation":yup.string().oneOf(["Haryana","Chandigarh","Himachal Pradesh","other"],'please select one').required('Required'),
      "options": [
        "Haryana",
        "Chandigarh",
        "Himachal Pradesh",
    ...
    },
    {
      ...
      "customProps":{label:"pick a Date","variant":"dialog","inputVariant":"outlined"}
    },
    {
      name:"Gender",
    ...
    },
    {
      ...
      "customProps":{"aria-labelledby":"discrete-slider",valueLabelDisplay:"auto","step":1,"min":17
      ,"max":24 }
    },
    {
      name:"switch",
